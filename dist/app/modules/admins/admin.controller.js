...
const getAdminProfile = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateAdminProfile = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.user; // Perform a type assertion to JwtPayload
    const updatedData = req.body;
    const result = yield admin_service_1.AdminService.updateAdminProfile(
      id,
      updatedData
    );
    (0, sendResponse_1.default)(res, {
